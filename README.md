...
[11.1.2 with ghc-9.12.2](https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-11_1_2-aarch64-static-musl-ghc_9122.tar.zst?raw=true)

```
wget -c https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-11_1_2-aarch64-static-musl-ghc_9122.tar.zst?raw=true -O - | tar -I zstd -xv
```
