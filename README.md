...
[10.5.4 with ghc-9.12.2](https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-10_5_4-aarch64-static-musl-ghc_9122.tar.zst?raw=true)

```
wget -c https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-10_5_4-aarch64-static-musl-ghc_9122.tar.zst?raw=true -O - | tar -I zstd -xv
```

[10.6.3 with ghc-9.12.2](https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-10_6_3-aarch64-static-musl-ghc_9122.tar.zst?raw=true)

```
wget -c https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-10_6_3-aarch64-static-musl-ghc_9122.tar.zst?raw=true -O - | tar -I zstd -xv
```

#### Preprod/Preview/SanchoNet

[10.7.0 with ghc-9.12.2](https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-10_7_0-aarch64-static-musl-ghc_9122.tar.zst?raw=true)

```
wget -c https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cardano-10_7_0-aarch64-static-musl-ghc_9122.tar.zst?raw=true -O - | tar -I zstd -xv
```
...
[cncli-v6.7.0](https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cncli-v6_7_0.tar.zst?raw=true)

```
wget -c https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/cncli-v6_7_0.tar.zst?raw=true -O - | tar -I zstd -x
```
